...
DROP INDEX IF EXISTS idx_16477_at_state_id_latest_idx;
DROP INDEX IF EXISTS transaction_recipient_id_sender_id_idx;
...
CREATE INDEX IF NOT EXISTS idx_16588_subscription_time_next_index_subscription_id_latest_idx ON subscription (id, latest);