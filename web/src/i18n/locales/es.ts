...
const es: Locale = {
  ...
  dashboard: {
    chainOverview: 'Resumen de cadena',
    network: 'Red',
  ...
  info: {
    ...
    chainLanes:
      'Muestra qué peers están en la misma cadena que tu nodo y cuáles en cadenas competidoras, agrupados por dificultad acumulada.',
  },
}
