...
const pt: Locale = {
  ...
  dashboard: {
    chainOverview: 'Visão geral da cadeia',
    network: 'Rede',
  ...
  info: {
    ...
    chainLanes:
      'Mostra quais peers estão na mesma cadeia que seu nó e quais estão em cadeias concorrentes, agrupados por dificuldade acumulada.',
  },
}
